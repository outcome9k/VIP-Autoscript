...
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/FasterExE/VIP-Autoscript/main/sshws/ws-ovpn.py
...
wget -O /etc/systemd/system/ws-ovpn.service https://raw.githubusercontent.com/FasterExE/VIP-Autoscript/main/sshws/ws-ovpn.service && chmod +x /etc/systemd/system/ws-ovpn.service
#restart service
#
